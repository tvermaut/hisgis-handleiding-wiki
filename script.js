...
window.onload = (event) => {
    ...
    l = l.replaceAll('src="<span class="mw-editsection"><span class="mw-editsection-bracket">[</span><a href="/index.php?title=Basis&amp;veaction=edit&amp;section=1" class="mw-editsection-visualeditor" title="Deelpagina bewerken: Basis">bewerken</a><span class="mw-editsection-divider"> | </span><a href="/index.php?title=Basis&amp;action=edit&amp;section=1" title="Deelpagina bewerken: Basis">brontekst bewerken</a><span class="mw-editsection-bracket">]</span></span>','');
